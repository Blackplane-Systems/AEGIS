...
The public protocol layer also includes production-safe OT and building-automation coverage:
...
network intelligence, backend binding, and diagnostic retention. The report is exposed through the
